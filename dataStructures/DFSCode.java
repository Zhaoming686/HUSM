...
//			}
			...
			if(nonCandidates==null)
			{
				...
				DFSSearch df = new DFSSearch(singleGraph, cg,singleGraph.getFreqThreshold(),nonCandidates);
				df.searchExistances();

				//**********新加的
				df.SetUpperBoundOfPattern();
				setUpperBound(df.getUpperBound(Settings.UpperBoundType));
				setUtility(df.getUtility());
