...
public class DijkstraEngine
{
    ...
    /*********新加**********/
    /**
     * 新加的直接得到满足条件的一系列的点，并且get
     */
    //新加的，满足条件的所有点
    private List<Integer> verticesIDsCovered = new ArrayList<>();
    public void addVerticesIDsCovered(Integer v) {
        if (!this.verticesIDsCovered.contains(v)) this.verticesIDsCovered.add(v);
        return;
    }

    public List<Integer> getVerticesIDsCovered() {
        return verticesIDsCovered;
    }
}
